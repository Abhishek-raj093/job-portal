...
const ViewApplications = () => {
  ...
  const [applicants, setApplicants] = useContext(false)
          ...
          <tbody>
            {applicants.filter(item => item.jobId && item.userId).map((applicant,index)=>(
              <tr key={index} className='text-gray-700'>
                ...
                <td className='py-2 px-4 border-b text-center flexItems-center'>
                  <img className='w-10 h-10 border-full mr-3 max-sm:hidden' src={applicant.userId.image} alt="" />
